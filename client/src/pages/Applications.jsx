        ...
        <div className='flex gap-2 mb-6 mt-3'>
          {isEdit ? (
            ...
            <div className='flex gap-2'>
              <a
                className='!no-underline bg-blue-100 text-blue-600 px-4 py-2 rounded-lg mr-2'
                href=''
              >
                Resume
              </a>
              <button
                className='text-gray-500 border cursor-pointer border-gray-300 !rounded-lg px-4 py-2'
