...
import generateToken from "../utils/genToken.js";  // Import token generation function

export const registerUser = async (req, res) => {
    const { name, email, password, resume, image } = req.body; // Remove _id from destructuring
    ...
    try {
        ...
        // Create new user with plain text password (pre-save hook will hash it)
        const newUser = new User({
            name,
            email,
            password, // Now set to plain text
            resume,
            image
        });
